...
- [Anlilam](https://andy23512.github.io/alnilam/) (Companion project for CharaChorder Lite)
...
- Device Layout View
  ...
  - can load the custom layout from a file (backup file from device manager website) or from a device
- Widgets
